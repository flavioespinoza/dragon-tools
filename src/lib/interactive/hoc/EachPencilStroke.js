...
class EachPencilStroke extends Component {
	constructor(props) {
		super(props)
	...
	render() {
		...
		return (
			<g>
				<PencilComponent ref={this.saveNodeType('fan')}
...
export default EachPencilStroke